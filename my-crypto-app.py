...
# 動画のURL
video_url = "https://www.youtube.com/watch?v=7AemXf8zGic"

def play_youtube_with_button(url):
    # 動画IDを抽出
    video_id = url.split("v=")[-1]

    video_html = f'''
        <div style="width: 100%; text-align: center;">
            <div id="player" style="border-radius: 10px; overflow: hidden; width: 100%;"></div>
    ...
    '''
    # プレイヤーとボタンが収まるように高さを調整
    st.components.v1.html(video_html, height=300)

# 実行
play_youtube_with_button(video_url)
# --- 解説部分（3分割） ---
